...
public class KeyboardView : MonoBehaviour {
 ...
 public Transform[] tops=new Transform[61];public Renderer[] sockets=new Renderer[61];public GameObject[] pieces=new GameObject[61];[System.NonSerialized] private Key[] cachedKeys; public Key[] keys { get { if(cachedKeys==null) cachedKeys=Layout(); return cachedKeys; } set { cachedKeys=value; } }
